...
> Проверьте видео до того, как копировать его на флешку
> TVCheck помогает заранее оценить, насколько видео соответствует ограничениям телевизора: контейнер, кодеки, разрешение, профиль/уровень, аудиодорожки, субтитры и битрейт.
...
<p align="center">
  <img src="screenshots/00-hero-context-menu.png" width="100%" alt="TVCheck — проверка видео через контекстное меню Windows">
</p>
